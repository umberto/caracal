        ...
        base.class_eval do
          ...
          def self.default_list_styles
            [
              ...
              { type: :ordered,   level: 2, format: 'lowerRoman',  value: '%3.', left: 2160, indent: 1800,
                align: :right },
              ...
              { type: :ordered,   level: 5, format: 'lowerRoman',  value: '%6.', left: 4320, indent: 3960,
                align: :right },
              ...
              { type: :ordered,   level: 8, format: 'lowerRoman',  value: '%9.', left: 6480, indent: 6120,
                align: :right },
          ...
          def unregister_list_style(type, level)
            return unless (s = find_list_style(type, level))
