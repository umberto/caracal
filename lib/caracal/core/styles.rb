        ...
        base.class_eval do
          ...
          def self.default_styles
            [
              ...
              { id: 'TOC1',     name: 'TOC 1',     font: 'Palatino', size: 22, bottom: 120 },
              { id: 'TOC2',     name: 'TOC 2',     font: 'Arial',    size: 22, bottom: 120, top: 120, indent_left:   0, bold: true },
              { id: 'TOC3',     name: 'TOC 3',     font: 'Arial',    size: 22, bottom: 120, top: 120, indent_left: 120, bold: true },
