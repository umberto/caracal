...
describe Caracal::Core::ListStyles do
  let(:s1) do
    Caracal::Core::Models::ListStyleModel.new({ type: :ordered, level: 10, format: 'decimal', value: '%1.' })
  end
  let(:s2) do
    Caracal::Core::Models::ListStyleModel.new({ type: :ordered, level: 11, format: 'lowerLetter', value: '%2.' })
  end
